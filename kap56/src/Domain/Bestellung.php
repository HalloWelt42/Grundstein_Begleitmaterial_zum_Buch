 ...
 * die Zeit gleich bleibt, auch wenn sich ihr Zustand ändert. Sie kennt weder
 * PDO noch HTTP noch einen Mailer - nur ihre eigene Fachlogik. Weil sie
 * unveränderlich ist, liefert jede Zustandsänderung ein neues Objekt zurück.
 * Übernommen aus Kapitel 55.
 */
final class Bestellung
{
    ...
    // Eine frische Bestellung hat noch keine id - die vergäbe erst der
